...
顶层仍保留同名薄入口（T1.py / T3.py / T4.py / T4_figures.py / sim_api.py），所以原有的
命令行用法一字不改：
...
分层原则：**依赖只能向下**。common 不 import 任何题目模块；t1/t3/t4 可 import common，
...
__all__ = ["common", "t1", "t3", "t4", "analysis"]
__version__ = "0.2.1"
