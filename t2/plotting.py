...
from common.plotting import (C_FRAME, C_GRAY, C_MEAS, C_PATH, C_SRC, font_context,
                                   no_plot_hint, save_png, setup_mpl_env)
from t2 import config as cfg
from t2 import theory
from t2.region import quad_diameters
from t2.score import SolveResult, scenario_quad, suitability
